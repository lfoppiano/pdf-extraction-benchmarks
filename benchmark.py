...
from pdf_benchmark.library_code import (
    ...
    pdfalto_get_text,
    pdfalto_get_images, markitdown_get_text, pdfalto2_get_text,
)
...
if __name__ == "__main__":
    docs = [
        ...
        Document(name="2201.00021", url="https://arxiv.org/pdf/2201.00021v1.pdf"),
    ...
    libraries = {
        ...
        "pdfplumber": Library(
            ...
            text_extraction_function=pdfplumber_get_text,
        ...
        "pdfalto": Library(
            ...
            version="0.4",
            watermarking_function=None,
            image_extraction_function=pdfalto_get_images,
            license="GPLv2",
            last_release_date="2021-04-12",
            dependencies="",
        ),
        "markitdown": Library(
            "markitdown",
            "markitdown",
            "https://github.com/kermitt2/pdfalto",
            text_extraction_function=markitdown_get_text,
            version="0.1.1",
            watermarking_function=None,
        ...
        "pdfalto_v0.6-dev": Library(
            "pdfalto_v0.6-dev",
            "pdfalto_v0.6-dev",
            "https://github.com/kermitt2/pdfalto",
            text_extraction_function=pdfalto2_get_text,
            version="0.6",
            watermarking_function=None,
            license="GPLv2",
            last_release_date="-",
